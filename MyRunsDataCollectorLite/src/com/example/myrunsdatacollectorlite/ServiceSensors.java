...
public class ServiceSensors extends Service implements SensorEventListener {
	...
	public int onStartCommand(Intent intent, int flags, int startId){
		...
		// TODO: add something like this for roll, yaw, pitch, and rubbing 
		Log.d(Globals.TAG, mFeatureFile.getAbsolutePath());
		//if the task is data collection, then create an empty dataset
		...
		if("collecting".compareTo(extras.getString("type"))==0){
		 ...
		 DecimalFormat df = new DecimalFormat("0000");
		  ...
		  allAttr.add(new Attribute("fft_coef_" + df.format(i)));
		   ...
		   labelItems.add("yaw");
		   labelItems.add("roll");
		   labelItems.add("pitch");
		   labelItems.add("rubbing");
